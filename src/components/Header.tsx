...
export default function Header() {
  return (
    <header className="h-16 border-b border-zinc-800/80 flex items-center justify-between px-6 shrink-0 bg-[#101018]/60 backdrop-blur-md relative">
      {/* Subtle top glow */}
      ...
      <div className="flex items-center flex-1 max-w-lg">
        <div className="relative w-full group">
          ...
          <input
            ...
            className="w-full bg-[#151520] border border-zinc-800/80 text-white placeholder-[var(--text-secondary)] px-10 py-2.5 rounded-[12px] text-sm focus:outline-none focus:border-[var(--primary)] focus:shadow-[0_0_0_3px_var(--primary-glow)] transition-all duration-300"
          />
